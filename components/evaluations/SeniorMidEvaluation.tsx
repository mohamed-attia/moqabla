...
import { SENIOR_EVALUATION_TEMPLATE } from '../../lib/evaluation-templates';
...
const SeniorMidEvaluation: React.FC<Props> = ({ registration, onComplete, onCancel, interviewerName }) => {
  ...
  const scoreLabels = ['Not Demonstrated', 'Basic Awareness', 'Developing', 'Competent', 'Strong Expert'];
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="flex items-center gap-5">
              ...
              <div className="text-right md:text-right">
                ...
                <div className="flex items-center gap-2 text-accent/90 text-sm font-bold mt-1">
                  ...
                  <span>Senior Level Assessment Flow</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-8">
              ...
              <div className="text-left">
                ...
                <div className={`text-4xl font-black transition-colors duration-500 ${totalScore >= 80 ? 'text-emerald-400' : totalScore >= 65 ? 'text-amber-400' : 'text-rose-400'}`}>
                  {totalScore}%
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-50 p-6 md:p-12 rounded-[3rem] border-2 border-dashed border-gray-200">
              <div className="flex items-center justify-between mb-10 flex-wrap gap-4">
                <div className="flex items-center gap-4">
                  ...
                  <h3 className="text-2xl font-black text-gray-800">مراجعة التقرير الذكي (Senior)</h3>
                </div>
              ...
              <div id="final-report-preview-senior" className="bg-white rounded-[2rem] p-6 md:p-10 shadow-sm border border-gray-100 prose prose-teal max-w-none dir-rtl text-right">
                <div className="mb-6 p-4 bg-emerald-50 rounded-2xl border border-emerald-100 flex justify-between items-center no-pdf">
                   <span className="font-bold text-emerald-800">الدرجة النهائية (Senior):</span>
...
export default SeniorMidEvaluation;
