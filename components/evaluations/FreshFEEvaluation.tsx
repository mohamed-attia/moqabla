...
import { FRESH_FE_EVALUATION_TEMPLATE } from '../../lib/evaluation-templates';
...
const FreshFEEvaluation: React.FC<Props> = ({ registration, onComplete, onCancel, interviewerName }) => {
  ...
  const [sections, setSections] = useState<EvaluationSection[]>(JSON.parse(JSON.stringify(FRESH_FE_EVALUATION_TEMPLATE)));
  ...
  const handleAiSuggest = async (sectionIdx: number, itemIdx: number) => {
    ...
    try {
      const suggestion = await AIAgent.suggestNote(
          item.skill, 
          item.score, 
          'Fresh Frontend Engineer (React/Angular focus)'
      );
            ...
            <div className="flex items-center gap-5">
              ...
              <div className="text-right">
                ...
                <div className="flex items-center gap-2 text-accent/90 text-sm font-bold mt-1">
                  ...
                  <span>Fresh Frontend Assessment Flow</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-50 p-6 md:p-12 rounded-[3rem] border-2 border-dashed border-gray-200">
              <div className="flex items-center justify-between mb-10 flex-wrap gap-4">
                <div className="flex items-center gap-4">
                  ...
                  <h3 className="text-2xl font-black text-gray-800">مراجعة تقرير Frontend Fresh</h3>
                </div>
...
export default FreshFEEvaluation;
