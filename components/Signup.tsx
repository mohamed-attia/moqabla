  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-24 pb-12 flex items-center justify-center px-4">
      <div className="bg-white p-8 rounded-2xl shadow-lg max-w-md w-full border border-gray-100">
        <h2 className="text-2xl font-bold text-center text-primary mb-6">إنشاء حساب جديد</h2>
        ...
        <form onSubmit={handleSignup} className="space-y-4">
          <div>
            ...
            <div className="relative">
              ...
              <input
                type="text"
                required
                className="w-full pr-10 pl-3 py-2 border border-gray-300 rounded-lg focus:ring-accent focus:border-accent"
                value={name}
          ...
          <Button type="submit" className="w-full justify-center" disabled={loading}>
            {loading ? <Loader2 className="w-5 h-5 animate-spin" /> : 'تسجيل'}
          </Button>
        </form>
        ...
        <div className="mt-6">
          ...
          <button
            ...
            className="mt-6 w-full flex justify-center items-center gap-2 px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-lg text-gray-700 bg-white hover:bg-gray-50 transition-colors"
          >
